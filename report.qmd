...
$\H_o:$ IMDB Rating and Passing the Bechdel test are independent of each other $\H_a$ IMDB Rating and passing of the Bechdel test are not independent of each other
